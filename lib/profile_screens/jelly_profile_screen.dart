...
class JellyProfileScreen extends StatelessWidget {
  const JellyProfileScreen({Key? key}) : super(key: key);
                ...
                children: [
                  Container(
                    ...
                    child: const Align(
                      ...
                      child: CircleAvatar(
                        radius: 87,
                        backgroundImage: AssetImage("assets/images/Jelly.jpg"),
                      ),
                    ),
                  ),
                  SizedBox(height: 10,),
